...
drop trigger if exists task_completion_achievements on public.task_completion_events;
create trigger task_completion_achievements
  after insert on public.task_completion_events
  for each row execute function public.award_task_achievements();